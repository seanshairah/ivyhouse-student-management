...
export function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      className="border-t border-border bg-secondary/60 scroll-mt-24 py-20 sm:py-28"
    >
      <div className="container">
        ...
        >
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-sand-500">
            How it works
          </p>
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            {howItWorks.map((step, i) => {
              ...
              return (
                ...
                >
                  <div className="relative z-10 mx-auto grid size-14 place-items-center rounded-full bg-sand-400 text-white shadow-md shadow-sand-400/30 ring-8 ring-secondary/60">
                    <Icon className="size-6" />
                  </div>
                  <span className="mt-4 inline-block font-display text-xs font-bold uppercase tracking-wider text-sand-500">
